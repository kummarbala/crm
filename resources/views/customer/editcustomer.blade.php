            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="addcustomer" method="POST" action="{{ route('editcustomersubmit',[$editCustomerData->customerId]) }}">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <div class="container-fluid">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="name" name="name"
                                                            placeholder="Name" value="{{$editCustomerData->name}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="3"
                                                            ...
                                                            id="address">{{$editCustomerData->address}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="phone" name="phone"
                                                            placeholder="Phone No" value="{{$editCustomerData->phone}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="email" name="email"
                                                            placeholder="Email Address" value="{{$editCustomerData->email}}" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="customerCode"
                                                            name="customerCode" placeholder="Vendor Code" value="{{$editCustomerData->customerCode}}"  >
                                                    </div>
                                                </div>`
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="tinNo"
                                                            name="tinNo" placeholder="TIN No" value="{{$editCustomerData->tinNo}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="cstNo"
                                                            name="cstNo" placeholder="GST No" value="{{$editCustomerData->cstNo}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="shortName"
                                                            name="shortName" placeholder="Short Name" value="{{$editCustomerData->shortName}}" >
                                                    </div>
                                                </div>
                                            </div>
