            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('orderacknowledgements') }}">Orderacknowledgement</a></li>
                        ...
                        <div class="card-header">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 float-right"> <a
                                        href="{{ route('orderacknowledgements') }}"><button type="button"
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <input type="text" class="form-control" id="ctsRef"
                                                            name="quotationId" placeholder="Customer Name" value="{{$editOrderacknowledgementData->ctsRef}}" readonly>
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="customerName"
                                                            name="customerName" placeholder="Customer Name" value="{{$editOrderacknowledgementData->name}}" readonly>
                                                        <input type="hidden" class="form-control" id="customerId"
                                                            name="customerId" placeholder="customerId" value="{{$editOrderacknowledgementData->customerId}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="ctsYear"
                                                            name="ctsYear" placeholder="CTS Year" value="{{$editOrderacknowledgementData->ctsYear}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="orderAckNo"
                                                            name="orderAckNo" placeholder="order Ack No" value="{{$editOrderacknowledgementData->orderAckNo}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="orderDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                data-toggle="datetimepicker" value="{{$editOrderacknowledgementData->orderDate}}" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="vendorCode"
                                                            name="vendorCode" placeholder="Enquiry Ref" value="{{$editOrderacknowledgementData->customerCode}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="poNo" name="poNo"
                                                            placeholder="P.O. No / Date" value="{{$editOrderacknowledgementData->poNo}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="enquireyNo"
                                                            name="enquireyNo" placeholder="Enq No / Date" value="{{$editOrderacknowledgementData->enquireyNo}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="priceBasis"
                                                            name="priceBasis" placeholder="Price Basis" value="{{$editOrderacknowledgementData->priceBasis}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="modeDespatch"
                                                            name="modeDespatch" placeholder="Mode of Despatch" value="{{$editOrderacknowledgementData->modeDespatch}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="destination"
                                                            name="destination" placeholder="Destination" value="{{$editOrderacknowledgementData->destination}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="freightDetails"
                                                            name="freightDetails" placeholder="Freight Details" value="{{$editOrderacknowledgementData->freightDetails}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="consignee"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="consignee"
                                                            name="consignee" placeholder="Consignee" value="{{$editOrderacknowledgementData->consignee}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="packingForward"
                                                            name="packingForward" placeholder="PF Charges" value="{{$editOrderacknowledgementData->packingForward}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="terms" name="terms"
                                                            placeholder="Terms of payemnt" value="{{$editOrderacknowledgementData->terms}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="gstNo" name="gstNo"
                                                            placeholder="GST No" value="{{$editOrderacknowledgementData->gstNo}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="contactPerson"
                                                            name="contactPerson" placeholder="Conatct Person" value="{{$editOrderacknowledgementData->contactPerson}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="note" name="note"
                                                            placeholder="Notes" value="{{$editOrderacknowledgementData->note}}">
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-12 clear-both">
                                    ...
                                    <table id="quotationprds" class="table table-bordered table-striped">
                                        ...
                                        @foreach($editOaProductData as $editOaProduct)
                                            <tr>
                                                ...
                                                <td>{{$editOaProduct['unit']}}<input type="hidden" class="unit" name="unit[]" value="{{$editOaProduct['unit']}}"></td>
                                                <td>{{$editOaProduct['total']}}<input type="hidden" class="total" name="total[]" value="{{$editOaProduct['total']}}"></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
