            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Orderacknowledgement</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <h3 class="card-title pTop10">Add Orderacknowledgement</h3>
                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control quotationId" style="width: 100%;"
                                                            ...
                                                            <option value="" selected="selected">Select a Quotation
                                                            </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="orderAckNo"
                                                            name="orderAckNo" placeholder="order Ack No" value="{{$ackNo}}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="orderDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                data-toggle="datetimepicker" value="@php echo date('m/d/Y') @endphp" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="vendorCode"
                                                            name="vendorCode" placeholder="Enquiry Ref">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="enquireyNo"
                                                            name="enquireyNo" placeholder="Enq No / Date">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="freightDetails"
                                                            name="freightDetails" placeholder="Freight Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="consignee"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="consignee"
                                                            name="consignee" placeholder="Consignee">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="packingForward"
                                                            name="packingForward" placeholder="PF Charges">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
