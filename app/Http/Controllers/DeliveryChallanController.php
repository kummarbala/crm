...
class DeliveryChallanController extends Controller
{
    ...
    public function index()
    {
        ...
        $deliverychallansData = DB::table('deliverychallan')
            ->join('customers', 'customers.customerId', '=', 'deliverychallan.customerId')
            ->select('deliverychallan.*', 'customers.name')
            ->orderBy('deliverychallan.deliveryChallanId','desc')
            ->get();     
        
        return view('deliverychallan.deliverychallans')
        ->with('deliverychallansData',$deliverychallansData)
        ->with('page',$page)
