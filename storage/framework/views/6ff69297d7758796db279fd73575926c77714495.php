                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <h3 class="card-title pTop10">Add Quotation</h3>
                                </div>
                        ...
                        <form class="form-horizontal" id="addQuotation" method="POST"
                            action=" <?php echo e(route('addquotationsubmit')); ?>">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="ctsyear" class="col-sm-2 col-form-label">CTS Year
                                                    No</label>
                                                <div class="col-sm-9">
                                                    <?php $year = date('Y') ;if(date('n')>=4) { $newyear = $year." - ".($year+1) ;}else{$newyear = ($year-1)." - ". $year; }?>
                                                    <input type="text" class="form-control" id="ctsYear" name="ctsYear"
                                                        placeholder="CTS Year" value="<?php echo trim($newyear); ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="ctsref" class="col-sm-2 col-form-label">CTS Ref</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="ctsRef" name="ctsRef"
                                                        placeholder="CTS Ref" value="">
                                                    <input type="hidden" class="form-control" name="referenceNo" id="referenceNo"
                                                        value="" >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            ...
                                            <div class="col-sm-6 float-right"> <button type="button"
                                                    ...
                                                    data-toggle="modal" data-target="#addProductModal" id="addProduct"
                                                    disabled='disabled'><i class="fas fa-plus"></i> Add</button>
                                            </div>
                                            <div class="col-sm-6">
                                            <div class="form-group row">
