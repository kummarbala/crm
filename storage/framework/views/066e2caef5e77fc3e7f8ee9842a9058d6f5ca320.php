                        ...
                        <div class="card-header">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="<?php echo e(route('addcustomer')); ?>"><button type="button"
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($customers->customerCode); ?></td>
                                        <td><?php echo e($customers->cstNo); ?></td>
                                        <td><?php echo e($customers->shortName); ?></td>
                                        <td><a href="<?php echo e(route('editcustomer',[$customers->customerId])); ?>"
                                                class="actionbutwrapper"><i
                                                    class="fas fa-edit actionbuttonsize"></i></a><a
                                                    href="<?php echo e(route('deletecustomer',[$customers->customerId])); ?>"
                                                class="actionbutwrapper "  id="<?php echo e($customers->customerId); ?>" onclick="return confirm('Are you sure you want to delete this Customer?');"><i
                                                    class="fas fa-trash-alt actionbuttonsize"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <!-- <?php echo e(route('deletecustomer',[$customers->id])); ?> -->
                                </tbody>
