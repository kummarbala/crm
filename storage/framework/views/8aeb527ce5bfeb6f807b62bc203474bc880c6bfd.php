                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <h3 class="card-title pTop10">Add Delivery Challan</h3>
                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" style="width: 100%;"
                                                            id="orderAckNo" name="orderAckNo">
                                                            <option value="" selected="selected">Select a Ack No
                                                            </option>
                                                            <?php $__currentLoopData = $oAData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oA): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($oA->orderAckNo); ?>">
                                                                <?php echo e($oA->orderAckNo); ?></option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="noPackages"
                                                            name="noPackages" placeholder="No of Packages">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="rrLrNo"
                                                            name="rrLrNo" placeholder="RR / LR. No">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="rrDate"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="rrDate"
                                                            name="rrDate" placeholder="RR / LR. Date">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
