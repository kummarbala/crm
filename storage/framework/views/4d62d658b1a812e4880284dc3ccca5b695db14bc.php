            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('deliverychallans')); ?>">Delivery Challan</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 float-right"> <a
                                        href="<?php echo e(route('deliverychallans')); ?>"><button type="button"
                        ...
                        <form class="form-horizontal" id="adddeliverychallan" method="POST"
                            action=" <?php echo e(route('editdeliverychallansubmit',[$editDeliveryChallanIdData->deliveryChallanId])); ?>">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="orderAckNoId"
                                                            name="orderAckNo" placeholder="Ack No" value="<?php echo e($editDeliveryChallanIdData->orderAckNo); ?>" readonly>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="challanNo"
                                                            name="challanNo" placeholder="Customer Name" value="<?php echo e($editDeliveryChallanIdData->challanNo); ?>" readonly>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="ctsYear"
                                                            name="ctsYear" placeholder="CTS Year" value="<?php echo e($editDeliveryChallanIdData->ctsYear); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="customerName"
                                                            name="customerName" placeholder="Customer Name" value="<?php echo e($editDeliveryChallanIdData->name); ?>" readonly>
                                                        <input type="hidden" class="form-control" id="customerId"
                                                            name="customerId" placeholder="customerId" value="<?php echo e($editDeliveryChallanIdData->customerId); ?>" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="poNo" name="poNo"
                                                            placeholder="P.O. No / Date" value="<?php echo e($editDeliveryChallanIdData->poNo); ?>" >
                                                    </div>
                                                </div>                                                
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="gstNo"
                                                            name="gstNo" placeholder="GST No" value="<?php echo e($editDeliveryChallanIdData->gstNo); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="modeDespatch"
                                                            name="modeDespatch" placeholder="Mode of Despatch" value="<?php echo e($editDeliveryChallanIdData->modeDespatch); ?>">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="dcDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                data-toggle="datetimepicker" value="<?php echo e($editDeliveryChallanIdData->dcDate); ?>" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="noPackages"
                                                            name="noPackages" placeholder="No of Packages" value="<?php echo e($editDeliveryChallanIdData->noPackages); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="rrLrNo"
                                                            name="rrLrNo" placeholder="RR / LR. No" value="<?php echo e($editDeliveryChallanIdData->rrLrNo); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="rrDate"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="rrDate"
                                                            name="rrDate" placeholder="RR / LR. Date" value="<?php echo e($editDeliveryChallanIdData->rrDate); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="contactPerson"
                                                            name="contactPerson" placeholder="Conatct Person" value="<?php echo e($editDeliveryChallanIdData->contactPerson); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="vendorCode" name="vendorCode"
                                                            placeholder="Vendor Code" value="<?php echo e($editDeliveryChallanIdData->customerCode); ?>" readonly>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-12 clear-both">
                                    ...
                                    <table id="oaproducts" class="table table-bordered table-striped">
                                        ...
                                        <?php $__currentLoopData = $editDcProductData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $editDcProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($editDcProduct['description']); ?><input type="hidden" class="description" name="description[]" value="<?php echo e($editDcProduct['description']); ?>"></td>
                                                <td><?php echo e($editDcProduct['drawingNo']); ?><input type="hidden" class="drawingNo" name="drawingNo[]" value="<?php echo e($editDcProduct['drawingNo']); ?>"></td>
                                                <td><?php echo e($editDcProduct['material']); ?><input type="hidden" class="material" name="material[]" value="<?php echo e($editDcProduct['material']); ?>"></td>
                                                <td><?php echo e($editDcProduct['quantity']); ?><input type="hidden" class="quantity" name="quantity[]" value="<?php echo e($editDcProduct['quantity']); ?>"></td>
                                                <td><?php echo e($editDcProduct['rate']); ?><input type="hidden" class="rate" name="rate[]" value="<?php echo e($editDcProduct['rate']); ?>"></td>
                                                <td><?php echo e($editDcProduct['unit']); ?><input type="hidden" class="unit" name="unit[]" value="<?php echo e($editDcProduct['unit']); ?>"></td>
                                                <td><?php echo e($editDcProduct['total']); ?><input type="hidden" class="total" name="total[]" value="<?php echo e($editDcProduct['total']); ?>"></td>
                                                <td><input type="text" class="per" name="remarks[]" value="<?php echo e($editDcProduct['remarks']); ?>"></td>
