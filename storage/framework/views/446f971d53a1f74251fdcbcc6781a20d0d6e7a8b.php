                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="<?php echo e(route('addinvoice')); ?>"><button type="button"
                        ...
                        <div class="card-body">
                            <table id="despatchadvicetable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php $__currentLoopData = $invoicesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><?php echo e($invoices->invoiceNo); ?></td>
                                        <td><?php echo e($invoices->challanNo); ?></td>
                                        <td><?php echo e($invoices->name); ?></td>                                        
                                        <td><?php echo e($invoices->contactPerson); ?></td>
                                        <td><a href="<?php echo e(route('editdeliverychallan',[$invoices->invoiceId ])); ?>"
                                                class="actionbutwrapper" title="Edit"><i
                                                    class="fas fa-edit actionbuttonsize"></i></a><a
                                                href="<?php echo e(route('deletedeliverychallan',[$invoices->invoiceId ])); ?>"
