                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control quotationId" style="width: 100%;"
                                                            ...
                                                            <option value="<?php echo e($quotations->quotationId); ?>">
                                                                <?php echo e($quotations->ctsRef); ?></option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="orderAckNo"
                                                            name="orderAckNo" placeholder="order Ack No" value="<?php echo e($ackNo); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="orderDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                data-toggle="datetimepicker" value="<?php echo date('m/d/Y') ?>" />
