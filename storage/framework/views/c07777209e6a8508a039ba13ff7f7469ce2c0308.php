            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('customers')); ?>">Quotations</a></li>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 float-right"> <a href="<?php echo e(route('quotations')); ?>"><button
                        ...
                        <form class="form-horizontal" id="addQuotation" method="POST"
                            action=" <?php echo e(route('editquotationsubmit',[$editQuotationData->quotationId])); ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control customername" style="width: 100%;"
                                                            ...
                                                            <option value="<?php echo e($customers->customerId); ?>"
                                                            <?php if($customers->customerId === $editQuotationData->customerId): ?> selected <?php endif; ?> >
                                                                <?php echo e($customers->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                        <input type="hidden" name="hiddenCustomerId" id="hiddenCustomerId" value="<?php echo e($editQuotationData->customerId); ?>">
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="ctsRef"
                                                            name="ctsRef" placeholder="CTS Ref" value="<?php echo e($editQuotationData->ctsRef); ?>" >
                                                        <input type="hidden" class="form-control" name="referenceNo"
                                                            id="referenceNo"
                                                            value="<?php echo e($editQuotationData->referenceNo); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="input-group date" id="ctsDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                value="<?php echo e($editQuotationData->ctsDate); ?>" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="enquiryRef"
                                                            ...
                                                            value="<?php echo e($editQuotationData->enquiryRef); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="contactPerson"
                                                            ...
                                                            value="<?php echo e($editQuotationData->contactPerson); ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="enquiryDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                name="enquiryDate"
                                                                value="<?php echo e($editQuotationData->customerId); ?>" />
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group date" id="dueDate"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                name="dueDate"
                                                                value="<?php echo e($editQuotationData->dueDate); ?>" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="3" placeholder="Notes ..."
                                                            name="notes"
                                                            id="notes"><?php echo e($editQuotationData->notes); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="subRequirement"
                                                            ...
                                                            value="<?php echo e($editQuotationData->subRequirement); ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12 clear-both">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="col-sm-6 float-right"> <button type="button"
                                                        ...
                                                        id="addProduct" <?php if($editQuotationData->customerId !== ""): ?> echo "disabled='disabled'" <?php endif; ?>><i class="fas fa-plus"></i>
                                                        Add</button>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                    ...
                                    <table id="quotationprds" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="productItem">
                                            <?php $__currentLoopData = $editQuotationProductData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $editQuotationProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="editable" >
                                                <td><?php echo e($editQuotationProduct['description']); ?><input type="hidden" class="description" name="description[]" value="<?php echo e($editQuotationProduct['description']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['drawingNo']); ?><input type="hidden" class="drawingNo" name="drawingNo[]" value="<?php echo e($editQuotationProduct['drawingNo']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['material']); ?><input type="hidden" class="material" name="material[]" value="<?php echo e($editQuotationProduct['material']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['quantity']); ?><input type="hidden" class="quantity" name="quantity[]" value="<?php echo e($editQuotationProduct['quantity']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['unit']); ?><input type="hidden" class="unit" name="unit[]" value="<?php echo e($editQuotationProduct['unit']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['rate']); ?><input type="hidden" class="rate" name="rate[]" value="<?php echo e($editQuotationProduct['rate']); ?>"></td>
                                                <td><?php echo e($editQuotationProduct['total']); ?><input type="hidden" class="total" name="total[]" value="<?php echo e($editQuotationProduct['total']); ?>"></td>
