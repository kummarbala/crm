                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="orderacknowledgementtable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php $__currentLoopData = $deliverychallansData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deliverychallans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><?php echo e($deliverychallans->challanNo); ?></td>
                                        <td><?php echo e($deliverychallans->name); ?></td>
                                        <td><?php echo e($deliverychallans->orderAckNo); ?></td>
                                        <td><?php echo e($deliverychallans->contactPerson); ?></td>
                                        <td><a href="<?php echo e(route('editdeliverychallan',[$deliverychallans->deliveryChallanId])); ?>"
                                                class="actionbutwrapper" title="Edit"><i
                                                    class="fas fa-edit actionbuttonsize"></i></a><a
                                                href="<?php echo e(route('deletedeliverychallan',[$deliverychallans->deliveryChallanId])); ?>"
                                                class="actionbutwrapper " id="<?php echo e($deliverychallans->deliveryChallanId); ?>"
